...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create rating' do
    assert_difference('Rating.count') do
      post ratings_url, params: { rating: { movie_id: @rating.movie_id, stars: @rating.stars } }
    end
  ...
  test 'should update rating' do
    patch rating_url(@rating), params: { rating: { movie_id: @rating.movie_id, stars: @rating.stars } }
